      ...
      body: SingleChildScrollView(
        child: Column(children: [
          Container(
            ...
            child: Padding(
              padding: EdgeInsets.symmetric(vertical: AppSize.defaultSize! * 5),
              child: TextApp(
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            ...
            Padding(
              padding:
                  EdgeInsets.symmetric(horizontal: AppSize.defaultSize! * 1),
              child: CustomElevatedButton(
                ...
                textSize: AppSize.defaultSize! * 1.5, bGColor: null,
              ),
            ),
          ]),
          Padding(
